                                    ...
                                    <tbody>
                                        <?php foreach($result as $row) : ?>
                                            <tr>
                                                ...
                                                <td><?= $row["status"] ?></td>
                                                <td><a href="" title="update"><i class="fas fa-sync-alt"></i></a> | <a href="" title="delete"><i class="fas fa-trash-alt"></i></a></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; FIRAL Website </div>
                            <div>
